  ...
  return (
    <header className="flex items-center w-full p-4 md:py-2 md:px-6">
      ...
      <ul className="flex items-center justify-center ml-7">
        ...
        <li className="mx-5 text-lg"><NavLink to={"/musics"}className={({isActive})=> isActive ? isActiveStyles : isNotActiveStyles}>Finger Spelling</NavLink></li>
        <li className="mx-5 text-lg"><NavLink to={"/premium"}className={({isActive})=> isActive ? isActiveStyles : isNotActiveStyles}>Videos</NavLink></li>
        {/* <li className="mx-5 text-lg"><NavLink to={"/contact"}className={({isActive})=> isActive ? isActiveStyles : isNotActiveStyles}>Games</NavLink></li> */}
        <li className="mx-5 text-lg"><NavLink to={"/premium"}className={({isActive})=> isActive ? isActiveStyles : isNotActiveStyles}>My Progress</NavLink></li>
      </ul>
      ...
      className="flex items-center ml-auto cursor-pointer gap-2 relative">
        ...
        <div className="flex flex-col">
          ...
          <FaCrown className="text-sm -ml-1 text-yellow-500" /></p>
        </div>
