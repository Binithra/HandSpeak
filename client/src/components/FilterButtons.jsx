...
const FilterButtons = ({filterData,flag}) => {
    ...
    const updateFilterButton =(name)=>{
        ...
        if (flag === "Level") {
          dispatch({ type: actionType.SET_LEVEL_FILTER, levelFilter: name });
        }
        if (flag === "Category") {
  ...
  return (
    <div className='border border-teal-700 rounded-md px-4 py-1 relative cursor-pointer hover:border-gray-400'>
