...
const Alert = ({type}) => {
  ...
  >
    <div className={`fixed top-12 right-12 p-4 rounded backdrop-blur-md flex items-center justify-center shadow-md
...
{type === "error" && (
        <div className="flex items-center justify-center gap-4">
          ...
          <p className="text-xl font-semibold text-primary">Something went wrong. Please try again!</p>
        </div>
      )}
    </div>
    </motion.div>
