...
router.post("/sendCertificateEmail", (req, res) => {
  ...
  if (score > 50) {
    ...
    let mailOptions = {
      ...
      text: "ශ්‍රවණාබාධිත ළමුන් සඳහා නිර්මාණය කර ඇති අපගේ සිංහල ඉගෙනුම් වේදිකාවේ ඉගෙනුම් මොඩියුල ඔබ සාර්ථකව නිම කර ඇති බව ඔබට දන්වා සිටින්නේ ඉතා සතුටිනි. ඔබගේ ජයග්‍රහණය අගයමින්, මෙම විද්‍යුත් තැපෑලට අමුණා ඇති සම්පූර්ණ කිරීමේ සහතිකයක් ඔබට පිරිනැමීමට අපි සතුටු වෙමු. මෙම සහතිකය ඉගෙනීමේ ක්‍රියාවලිය සඳහා ඔබේ වෙහෙස මහන්සි වී වැඩ කිරීම සහ කැපවීම පිළිබඳ සාක්ෂියක් ලෙස සේවය කරයි.",
      attachments: [
        {
